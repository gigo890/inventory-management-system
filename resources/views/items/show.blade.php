<x-app-layout>
   ...
   <div class="py-12 flex justify-center">
        ...
        <x-back-button></x-back-button>
            <div class="flex justify-center flex-row flex-wrap items-stretch m-5 w-fit min-w-96 h-auto bg-white rounded-lg shadow-lg">
                ...
                {{-- ITEM NAME --}}
                <div class=" m-5 flex flex-col justify-start min-w-300px w-80">
                    ...
                    <h1 class="mb-2 m-x-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-800 border-b-2 dark:border-gray-800 ">{{ ($item->name) }}</h1>
                    <h5 class="mt-2 border-b-2 dark:border-gray-700 font-bold">Dimensions: </h5>
                    <p>{{ ($item->dimensions) }}</p>
                    <h5 class="mt-2 border-b-2 dark:border-gray-700 font-bold">Description:</h5>
